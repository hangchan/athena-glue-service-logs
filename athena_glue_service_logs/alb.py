...
class ALBConvertedCatalog(BaseCatalogManager):
    ...
    def _columns():
        return [
            ...
            {"Name": "received_bytes", "Type": "int"},
            {"Name": "sent_bytes", "Type": "int"},
